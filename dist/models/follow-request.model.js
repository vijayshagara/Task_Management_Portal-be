...
let FollowRequest = class FollowRequest extends sequelize_typescript_1.Model {
};
...
__decorate([
    (0, sequelize_typescript_1.Column)({
        type: sequelize_typescript_1.DataType.ENUM(...Object.values(FollowRequestStatus)),
        defaultValue: FollowRequestStatus.PENDING,
    }),
    __metadata("design:type", String)
], FollowRequest.prototype, "status", void 0);
__decorate([
    (0, sequelize_typescript_1.BelongsTo)(() => user_model_1.default, 'requesterId'),
    __metadata("design:type", user_model_1.default)
], FollowRequest.prototype, "requester", void 0);
__decorate([
    (0, sequelize_typescript_1.BelongsTo)(() => user_model_1.default, 'targetId'),
    __metadata("design:type", user_model_1.default)
], FollowRequest.prototype, "target", void 0);
exports.FollowRequest = FollowRequest = __decorate([
    (0, sequelize_typescript_1.Table)({ tableName: 'follow_requests', timestamps: true })
], FollowRequest);
